...
import knapsack.BinaryBranchAndBoundSolver;
import knapsack.BinaryChocoKnapsackSolver;
import knapsack.BinaryChocoNotKnapsackSolver;
...
//			runSolver(new BinaryChocoKnapsackSolver(),instance);
//			runSolver(new BinaryChocoNotKnapsackSolver(),instance);
			break;
		default:
			throw new IllegalArgumentException(usage);
		}
	...
	public static String[] getArguments() {
		...
		String problem = "rucksack0060.txt";
